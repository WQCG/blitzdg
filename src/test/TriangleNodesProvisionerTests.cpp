...
namespace blitzdg {
    namespace TriangleNodesProvisionerTests {
        ...
        Describe(TriangleNodesProvisioner_Object) {
			...
			It(Should_Compute_Vandermode_Matrix_For_Triangular_Basis) {
				cout << "Should_Compute_Vandermode_Matrix_For_Triangular_Basis" << endl;

				const index_type Np = 0.5*(NOrder+1)*(NOrder+2);
				real_matrix_type V(Np, Np), V_expected(Np, Np);
				V = 0.0;

				V_expected = 0.70711,-1.00000,1.22474,-1.41421,-1.73205,2.12132,-2.44949,2.73861,-3.16228,-3.74166,
					0.70711,-1.00000,1.22474,-1.41421,-0.77460,0.94868,-1.09545,-0.54772,0.63246,1.67332,
					0.70711,-1.00000,1.22474,-1.41421,0.77460,-0.94868,1.09545,-0.54772,0.63246,-1.67332,
					0.70711,-1.00000,1.22474,-1.41421,1.73205,-2.12132,2.44949,2.73861,-3.16228,3.74166,
					0.70711,-0.17082,-0.54772,0.63246,-1.25332,-0.58632,1.26281,1.43396,1.54775,-1.41766,
					0.70711,-0.00000,-0.68041,0.41903,-0.00000,-0.00000,0.00000,-0.60858,-0.93697,0.00000,
					0.70711,-0.17082,-0.54772,0.63246,1.25332,0.58632,-1.26281,1.43396,1.54775,1.41766,
					0.70711,1.17082,0.54772,-0.63246,-0.47873,-1.53500,-2.24261,0.20921,0.98207,-0.07900,
					0.70711,1.17082,0.54772,-0.63246,0.47873,1.53500,2.24261,0.20921,0.98207,0.07900,
					0.70711,2.00000,3.67423,5.65685,-0.00000,-0.00000,-0.00000,0.00000,0.00000,-0.00000;

				triangleNodesProvisioner->computeVandermondeMatrix(NOrder, triangleNodesProvisioner->get_rGrid(), triangleNodesProvisioner->get_sGrid(), V);

				std::cout << "triangular vandermonde:\n" << V << '\n';
				V_expected -= V;

				Assert::That(normFro(V_expected), IsLessThan(epsf));
			}
			...
			It(Should_Compute_Differentiation_Matrices) {
				...
				triangleNodes.computeDifferentiationMatrices(V2Dr, V2Ds, V, V, Dr, Ds, Drw, Dsw);				
			...
			It(Should_Build_Cubature_Volume_Mesh) {
				...
				Assert::That(blitz::sum(fieldcub), Equals(36.0));
				...
				cholExpected = 3.83e-02,-1.40e-02,7.79e-04,1.98e-03,-1.40e-02,-1.55e-16,1.98e-02,7.79e-04,1.98e-02,1.98e-03,
					0.00e+00,9.30e-02,-6.68e-03,6.19e-04,4.19e-02,3.67e-02,-1.74e-02,-2.03e-02,-1.38e-02,8.45e-03,
					0.00e+00,0.00e+00,9.38e-02,-5.68e-03,-1.71e-02,3.90e-02,4.22e-02,-1.81e-02,-2.14e-02,8.67e-03,
					0.00e+00,0.00e+00,0.00e+00,3.78e-02,1.75e-02,5.26e-03,-8.58e-03,1.76e-02,-3.23e-03,3.07e-03,
					0.00e+00,0.00e+00,0.00e+00,0.00e+00,7.94e-02,3.09e-02,3.98e-03,-4.93e-03,-1.70e-02,-2.54e-03,
					0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,1.82e-01,1.28e-02,2.71e-02,2.91e-02,-3.22e-03,
					0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,7.82e-02,-2.14e-02,-8.92e-03,-1.92e-03,
					0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,8.11e-02,2.96e-02,-2.83e-03,
					0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,7.55e-02,-1.93e-03,
					0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,0.00e+00,3.57e-02;

				cholExpected -= MMchols(blitz::Range::all(), blitz::Range::all(), 0);

				Assert::That(normMax(cholExpected), IsLessThan(6.e-4));
			}
